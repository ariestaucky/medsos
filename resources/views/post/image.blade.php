        ...
        <div class="col-md-8">
            <div class="card gedf-card-post">
                ...
                <div class="card-body">                   
                    ...
                    <img class="card-img-top" src="{{asset('/public/user_album/' . $post->image)}}" alt="" style="width:50%; display:block; margin-left:auto; margin-right: auto;" data-toggle="modal" data-target="#pic{{$post->id}}" title="pic-{{$post->id}}">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="h7 text-muted">Uploaded by {{$post->user->name}}</div>
                                    </div>
                                    <div class="col-sm-6">         
                                ...
                                <div class="modal-body">
                                    <img class="card-img-top" src="{{asset('/public/user_album/' . $post->image)}}" alt="">
                                </div>
