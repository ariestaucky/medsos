        ...
        <div class="card gedf-card-post">
            ...
            <div class="card-footer">
                ...
                @else
                    ...
                    <div class="dropdown-menu text-center" aria-labelledby="gedf-drop1">
                        <div class="h6 dropdown-header">Share with</div>
                        <a class="btn btn-primary social-facebook dropdown-item share share-button" data-ref="{{route('show', $poster->id)}}" data-pos="{{$poster->caption}}"><i class="fa fa-facebook"></i>&nbsp; Facebook</a>
