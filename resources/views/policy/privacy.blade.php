    ...
    <div class="container">
        <div class="row" style="content-center">
            <div class="col-md-8 card">
                ...
                <p>Artikel uses the collected data for various purposes:</p>    
                <ul>
                ...
                <p>Artikel may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of Artikel</li>
                ...
                <ul>
                            <li>By visiting this page on our website page: <a href="/contact-us">Contact Us</a></li>    
                </ul>
                </div>
            </div>
        </div>
