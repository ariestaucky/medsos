    ...
    <div class="container">
        <div class="row" style="content-center">
            <div class="col-md-8 card">
                <div class="card-body">
                <h1>Cookie Policy for IMposter</h1>

                <p>This is the Cookie Policy for IMposter, accessible from <a href="https://imposter.000webhostapp.com">IMposter</a></p>
